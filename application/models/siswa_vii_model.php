...
class Siswa_vii_model extends CI_Model {
...
public function get()
{
	return $this->db->get_where('biodata_siswa' , ['id_kelas' => '1'])->result();
		// return $this->db->select('*')->from('biodata_siswa')->join('ms_kelas', 'ms_kelas.kd_kelas = biodata_siswa.kelas')->get();
}
