                                    ...
                                    <tr style="text-align: center;">
                                        ...
                                        <td><button type="button" class="btn btn-outline-success btn_edit_guru"
                                            ...
                                            <button type="button" class="btn btn-outline-danger"
                                                onclick="deleted_guru(<?= $row->id_guru ?>)">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Masukkan Jabatan" name="jabatan"
                                    autofocus autocomplete="off" id="jabatan">
                                <?= form_error('jabatan', '<small class="text-danger pl-3">', '</small>'); ?>
                            </div>
                            <div class="form-group">
                                <label for="nikg">NIKG</label>
                                <input type="number" class="form-control" placeholder="Masukkan NIKG" name="nikg"
                                    autofocus autocomplete="off" id="nikg">
                        ...
                        <div class="col-lg-12">
                            <form action="<?= base_url('edit_guru'); ?>" method="POST">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Masukkan Nama" name="nama"
                                        autofocus autocomplete="off" id="nama_guru_edit" value="">
                                    <?= form_error('nama', '<small class="text-danger pl-3">', '</small>'); ?>
                                </div>
                                <div class="form-group">
                                    <label for="jabatan">Jabatan Guru</label>
                                ...
                                <div class="form-group">
                                    <label for="nikg">NIKG</label>
                                    <input type="number" class="form-control" placeholder="Masukkan NIKG" name="nikg"
                                        autofocus autocomplete="off" id="nikg_edit" value="">
                                    <?= form_error('nikg', '<small class="text-danger pl-3">', '</small>'); ?>
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Tutup</button>
