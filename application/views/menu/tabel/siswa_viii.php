...
<head>
    ...
    <!-- Title Page-->
    <title>Daftar Siswa Kelas VIII</title>
        ...
        <div class="page-container">
                                    ...
                                    <table class="table table-borderless table-striped table-earning">
                                        ...
                                        <tbody>
                                            ...
                                            <tr style="text-align: center;">
                                                ...
                                                <td>
                                                    <button type="button"
                                                        class="btn btn-outline-success btn_edit_siswa_viii"
                                                        data="<?= $row->id_nilai ?>">
            ...
            <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel"
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="editModalLabel">Ubah Data Siswa Kelas VIII</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-lg-12">
                                    <form action="<?= base_url('edit_kelas_viii'); ?>" method="post">
                                        <div class="row">
                                            <div class="col-6">
                                                <div class="form-group">
